...
const RU_BarChart = () => {
  useEffect(() => {
    ...
    let chart = am4core.create('ruBarChart', am4charts.XYChart)
    chart.data = ruData

    let title = chart.titles.create()
    title.text = 'Out of School Children in Rural/Urban regions in Pakistan'
  ...
  return (
    <div
      className='ruBarChart shadow p-3 mb-5 bg-white rounded'
      style={{ width: '100%', height: '600px', marginTop: '50px' }}
    ></div>
  )
}

export default RU_BarChart
